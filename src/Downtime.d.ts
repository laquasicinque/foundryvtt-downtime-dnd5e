...
declare namespace Downtime {
  ...
  interface ActorSheetApplication
    extends dnd5e.applications.actor.ActorSheet5eCharacter2,
      SvelteSheet {
    activateTrainingTab: boolean;
    constructor: typeof dnd5e.applications.actor.ActorSheet5eCharacter2 & {
      MODE: { EDIT: number; VIEW: number };
    };
  }
  ...
  type TrackedItemV1Tool = Prettify<
    { progressionStyle: "TOOL"; tool: string } & TrackedItemBaseV1
  >;

  type TrackedItemV1Macro = Prettify<
    { progressionStyle: "MACRO"; macro: string } & TrackedItemBaseV1
  >;
