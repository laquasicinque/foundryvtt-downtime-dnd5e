...
declare namespace Downtime {
    interface ActorSheetApplication extends dnd5e.applications.actor.ActorSheet5eCharacter2 {
     ...
     * Tracked Item V2
     */
    type TrackedItemV2 = TrackedItemV2Fixed | TrackedItemV2Ability | TrackedItemV2Skill | TrackedItemV2Tool | TrackedItemV2Macro
    ...
    type TrackedItemV1 = TrackedItemV1Fixed | TrackedItemV1Ability | TrackedItemV1Skill | TrackedItemV1Tool | TrackedItemV1Macro
    ...
    type TrackedItemV1Skill = Prettify<{ progressionStyle: 'SKILL', skill: dnd5e.types.Skill.TypeKey } & TrackedItemBaseV1>
    ...
    type X<T, K> = T extends unknown ? Prettify<T & K> : never

    type CategoryWithActivities = {
        id: string,
        name: string,
        description: string,
        activities: X<TrackedItem, {
            dc: string | undefined,
    ...
    global {
        namespace Hooks {
            interface HookConfig {
                TrainingTabReady: (app: Downtime.ActorSheetApplication, html: JQuery, data: Record<string, unknown>) => void
            }
        }
